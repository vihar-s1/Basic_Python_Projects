...
# the solution here uses brute force method by recursively trying every possible solution untill it finds the right one
...
# . Calculates total possible solutions for the given puzzle
def solve_sudoku(puzzle):
    # TODO Step 1: choose next location on puzzle to guess
    ...
    for guess in range(1, 10):
        ...
        if is_valid_guess(puzzle, row, col, guess):
            ...
            total_solutions += solve_sudoku(puzzle)
...
if __name__ == "__main__":
    ...
    print("\nPossible Solutions:",Count,"\n")
    print("Time Taken:",toHMS(end-start),"\n")
